...
import { FiWifi, FiWifiOff, FiRefreshCw, FiZap } from 'react-icons/fi';
  ...
  return (
    <div className="h-14 bg-nt-surface border-b border-nt-border flex items-center px-5 gap-4 flex-shrink-0 z-10">
      ...
      <div className="ml-auto flex items-center gap-2 flex-shrink-0">
        ...
        {/* Avatar */}
        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-nt-blue/80 to-nt-cyan/60 flex items-center justify-center text-xs font-bold text-white border border-nt-blue/20 flex-shrink-0">
