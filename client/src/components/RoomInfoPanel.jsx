  ...
  return (
    <div className="w-72 flex-shrink-0 flex flex-col border-l overflow-hidden"
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b flex-shrink-0"
        ...
        <h3 className="text-sm font-bold" style={{ color: '#FFEFB2' }}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="flex flex-col items-center gap-3 px-5 py-6 border-b"
          ...
          {isRoom ? (
            <>
              {/* Group avatar — large letter */}
              <div className="w-20 h-20 rounded-full border-2 flex items-center justify-center text-3xl font-black"
                   style={{ background: 'linear-gradient(135deg, rgba(255,239,178,0.15), rgba(255,239,178,0.05))', borderColor: '#025A50', color: '#FFEFB2' }}>
        ...
        {isRoom && (
          <div className="px-5 py-4 space-y-3 border-b" style={{ borderColor: '#025A50' }}>
            <p className="section-label">Group Details</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full" style={{
                      background: { positive: '#4ADE80', excited: '#60D4C8', neutral: '#7A9E99', tense: '#FCD34D', negative: '#F87171' }[roomMood.mood] || '#7A9E99'
                    }} />
                    <span className="text-xs" style={{ color: '#7A9E99' }}>Group Mood</span>
                  </div>
                  ...
                  <div key={u.userId} className="flex items-center gap-2.5">
                    <div className="relative flex-shrink-0">
                      <div className="w-7 h-7 rounded-full overflow-hidden border flex items-center justify-center text-xs font-bold"
                           style={{ background: 'linear-gradient(135deg, #FFEFB2, #F5DC6E)', borderColor: '#025A50', color: '#013E37' }}>
                        {hasImg ? <img src={u.avatar} alt="" className="w-full h-full object-cover" /> : u.username?.[0]?.toUpperCase()}
                      </div>
