...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-nt-bg flex items-center justify-center px-4 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-nt-blue/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-nt-surface border border-nt-border rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-nt-muted text-sm text-center mt-6">
            ...
            <Link to="/register" className="text-nt-blue hover:text-nt-cyan font-medium transition-colors">Create one</Link>
          </p>
        </div>
